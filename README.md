...
## CICD Infra setup
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated-infra" (https://github.com/joelwatch/devops-fully-automated-infra.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated-infra" (https://github.com/joelwatch/devops-fully-automated-infra.git) & name it "devops-fully-automated-infra"**
